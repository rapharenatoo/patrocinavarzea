...
export function FormSponsor() {
  ...
  const [categoryTeamsSponsor, setCategoryTeamsSponsor] = React.useState([]);
  ...
  const {
    ...
    defaultValues: {
      ...
      phoneContact: String(infoSponsor[0]?.phoneContact),
    },
  });

  const validateUUIDUser =
    infoSponsor.length === 0 ? String(uuid.v4()) : String(infoSponsor[0]?.id);
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <VStack flex={1} px={10} pb={10}>
        ...
        <Controller
          control={control}
          name="categoryTeamsSponsor"
          render={({ field: { onChange, value } }) => (
            <Input
              bg="gray.600"
              placeholder="Quantidade de times à patrocinar: ChackBox"
              onChangeText={onChange}
              value={value}
              errorMessage={errors.categoryTeamsSponsor?.message}
            />
          )}
        />
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <Input
              bg="gray.600"
              placeholder="Tipo de Patrocínio: CheckBox"
              onChangeText={onChange}
              value={value}
              errorMessage={errors.sponsorshipType?.message}
            />
          )}
        />
