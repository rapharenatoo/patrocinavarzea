...
export type AppNavigatorRoutesProps = BottomTabNavigationProp<AppClubRoutes>;

const { Navigator, Screen } = createBottomTabNavigator<AppClubRoutes>();

export function AppClubRoutes() {
